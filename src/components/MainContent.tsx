...
const faqItems = [
  ...
  },
  {
    ...
    answer: 'Прикуривание автомобиля от 2000₽, запуск двигателя от 3500₽, экспресс-отогрев от 3000₽, полный отогрев всех систем от 3000₽. Выезд в пределах города включён в стоимость. Работаем с легковыми (12В) и грузовыми (24В) автомобилями.'
  },
  {
